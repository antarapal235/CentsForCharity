...
public class ChargeCall implements Call<ChargeResult> {
  ...
  public static class Factory {
    ...
    public Call<ChargeResult> create(String nonce) {
      return new com.example.smartpad.ChargeCall(this, nonce);
    }
  }

  private final com.example.smartpad.ChargeCall.Factory factory;
  private final String nonce;
  private final retrofit2.Call<Void> call;

  private ChargeCall(com.example.smartpad.ChargeCall.Factory factory,
                     String nonce) {
